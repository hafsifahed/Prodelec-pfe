...
import { WorkerSessionService } from 'src/app/core/services/worker-session.service';
...
export class HorizontaltopbarComponent implements OnInit, AfterViewInit {
  ...
  constructor(@Inject(DOCUMENT) private document: any, private router: Router, private eventService: EventService, private authService: AuthService,
    private authFackservice: AuthfakeauthenticationService,
    public languageService: LanguageService, private userServices : UsersService,  private workersService: WorkersService,
